...
\providecommand{\gitHash}{ed3b561edfa137c13b74c24bf1a3642a9c9356eb}
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.975\textwidth,height=0.4875\textwidth]{figure/snrinfhejci_plots-1} \caption{The empirical type I rate, over 1,000,000 simulations, of a one-sided confidence bound for $\psnr_{a}$ are shown for the hedged portfolio problem.  We set $\nstrathej=\nstrat/2$ and take $\pvmu\propto\vone$. The SNR in the facet titles refers to $\sqrt{\Hejpsnrsqopt{\hejG}}$. }\label{fig:hejci_plots}
\end{figure}
...
The set consists of $\ssiz=1187\,\moto{}$ of data, from 
Jan 1927 through Nov 2025. 
...
\ssrsqoptG{\hejG}=0.033\,\moto{-1},\quad
\Hejssrsqopt{\hejG}=0.062\,\moto{-1}.
$$
With $\ssiz=1187, \nstrat=4$, we 
compute the three KRS estimators of \Hejpsnrsqopt{\hejG}, which all take the same value,
$\delta_0=\delta_1=\delta_2=0.059\moto{-1}.$
