...
\providecommand{\gitHash}{55f8176fbc33bcf6b03f02174afb0d7e394105cf}
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.975\textwidth,height=0.4875\textwidth]{figure/snrinfhejci_plots-1} \caption[The empirical type I rate, over 100,000 simulations, of a one-sided confidence bound for $\psnr_{a}$ are shown more tk]{The empirical type I rate, over 100,000 simulations, of a one-sided confidence bound for $\psnr_{a}$ are shown more tk. }\label{fig:hejci_plots}
\end{figure}
